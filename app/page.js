...
export const metadata = {
  title: '계산기 모음 - 만나이, 급여, 전월세, BMI, 주휴수당, 적금, 대출, 시급 계산기',
  description:
    '만나이, 급여 실수령액, 전월세, 사주, BMI, 디데이, 퇴직금, 주휴수당, 적금, 대출, 칼로리, 시급 계산기를 한 곳에서 무료로 사용하세요. 2026년 기준 안내를 함께 제공합니다.',
  keywords: ['만나이 계산기', '급여 계산기', '주휴수당 계산기', '시급 계산기', '적금 이자 계산기', '대출 이자 계산기', '칼로리 계산기'],
