...
export const metadata = {
  title: '계산기 모음 - 만나이, 급여, 월급도둑, 전월세, BMI, 주휴수당, 적금, 대출, 시급 계산기',
  description:
    '만나이, 급여 실수령액, 월급 도둑, 전월세, 사주, BMI, 디데이, 퇴직금, 주휴수당, 적금, 대출, 칼로리, 시급 계산기를 한 곳에서 무료로 사용하세요. 2026년 기준 안내를 함께 제공합니다.',
  keywords: ['만나이 계산기', '급여 계산기', '월급 도둑 계산기', '주휴수당 계산기', '시급 계산기', '적금 이자 계산기', '대출 이자 계산기', '칼로리 계산기'],
  alternates: { canonical: pageUrl },
  openGraph: {
    title: '계산기 모음',
    description: '만나이·급여·전월세·BMI·주휴수당·적금·대출·시급 등 생활 계산기를 무료로 제공합니다.',
    url: pageUrl,
    type: 'website',
    locale: 'ko_KR',
  },
...
const CALCS = [
  ...
  },
  {
    href: '/bmi',
    title: 'BMI 계산기',
    desc: '키와 체중으로 체질량지수와 비만도 확인',
    emoji: '🏃',
  },
  {
    href: '/dday',
    title: '디데이 계산기',
    desc: '목표 날짜까지 D-day 실시간 카운트다운',
    emoji: '📅',
  },
  {
    href: '/retirement',
    title: '퇴직금 계산기',
    desc: '2026년 기준 퇴직금 및 퇴직소득세 계산',
    emoji: '💼',
  },
  {
    href: '/juhu',
    title: '주휴수당 계산기',
    desc: '2026년 기준 알바·파트타임 주휴수당 계산',
    emoji: '💰',
  },
  {
    href: '/savings',
    title: '적금 이자 계산기',
    desc: '월 납입금·이자율로 만기 수령액 계산',
    emoji: '🏦',
  },
  {
    href: '/loan',
  ...
  },
  {
    href: '/calorie',
    title: '칼로리 계산기',
    desc: '기초대사량(BMR)과 일일 권장 칼로리 계산',
    emoji: '🥗',
  },
  {
    href: '/hourly',
    title: '시급 계산기',
    desc: '시급으로 일급·주급·월급·연봉 환산',
    emoji: '⏰',
  },
  {
    href: '/wolgup-doduk',
    title: '월급 도둑 계산기',
    desc: '연봉 입력하면 세금·4대보험 항목별 공제액 계산',
    emoji: '💸',
  },
]
...
const CALC_DETAILS = [
  ...
  },
  {
    ...
    title: 'BMI 계산기',
    summary:
      'BMI 계산기는 키와 체중을 입력하면 체질량지수와 비만도를 즉시 계산합니다. WHO 아시아 기준으로 저체중·정상·과체중·비만·고도비만을 판정하고, 정상 체중 범위와 표준 체중을 함께 안내합니다. 시각적 게이지 바로 현재 위치를 한눈에 확인할 수 있습니다.',
    points: [
      'WHO 아시아·한국 기준 비만도 판정',
      '정상 체중 범위와 표준 체중 함께 확인',
      'BMI 구간 게이지 바로 직관적 표시',
    ],
  },
  {
    href: '/dday',
    title: '디데이 계산기',
    summary:
      '디데이 계산기는 목표 날짜를 선택하면 D-day를 즉시 계산하고 일·시간·분·초 실시간 카운트다운을 제공합니다. 수능, 크리스마스, 새해 등 자주 쓰는 날짜를 빠르게 선택할 수 있고, 여러 개의 디데이를 저장해 한 번에 관리할 수 있습니다.',
    points: [
      '일·시간·분·초 실시간 카운트다운',
      '수능, 크리스마스 등 자주 쓰는 날짜 빠른 선택',
      '최대 10개 디데이 저장 및 관리',
    ],
  },
  {
    ...
    title: '퇴직금 계산기',
    summary:
      '퇴직금 계산기는 입사일·퇴사일·최근 3개월 급여를 입력하면 평균임금, 퇴직금 예상액, 퇴직소득세, 세후 실수령액을 자동 계산합니다. 2026년 기준 근속연수공제와 환산급여공제를 반영해 퇴직소득세까지 한 번에 확인할 수 있습니다.',
    points: [
      '2026년 기준 퇴직금 및 퇴직소득세 계산',
      '근속연수공제·환산급여공제 자동 반영',
      '재직 기간·평균임금·실수령액 한눈에 확인',
    ],
  },
  {
    href: '/juhu',
    title: '주휴수당 계산기',
    summary:
      '주휴수당 계산기는 2026년 최저시급 10,320원을 기준으로 시급, 1일 근무시간, 주 근무일수를 입력하면 주휴수당 금액, 주급, 월급 환산액을 자동 계산합니다. 주 15시간 미만 근무 시 주휴수당이 발생하지 않는다는 안내도 함께 제공합니다.',
    points: [
      '2026년 최저시급 10,320원 기준',
      '주휴수당 발생 여부(주 15시간) 자동 판단',
      '주급·월급 환산액까지 한 번에 확인',
    ],
  },
  {
    ...
    title: '적금 이자 계산기',
    summary:
      '적금 이자 계산기는 월 납입금, 연 이자율, 적금 기간을 입력하면 만기 수령액, 세전·세후 이자를 즉시 계산합니다. 일반과세(15.4%)와 비과세를 선택할 수 있으며, 월별 이자 표로 납입 흐름을 상세히 확인할 수 있습니다.',
    points: [
      '단리 방식 만기 수령액과 세후 이자 계산',
      '일반과세(15.4%) / 비과세 선택 지원',
      '월별 이자 표로 납입 흐름 상세 확인',
    ],
  },
  {
    href: '/loan',
    title: '대출 이자 계산기',
    summary:
      '대출 이자 계산기는 대출금액, 연 이자율, 기간을 입력하면 월 납입금, 총 이자, 총 상환금액을 계산합니다. 원리금균등·원금균등·만기일시상환 세 가지 방식을 지원하며 상환 스케줄 표도 제공합니다.',
    points: [
      '3가지 상환 방식 선택 (원리금균등·원금균등·만기일시)',
      '총 이자와 총 상환금액 자동 계산',
      '월별 상환 스케줄 표 제공',
    ],
  },
  {
    ...
    title: '칼로리 계산기',
    summary:
      '칼로리 계산기는 성별, 나이, 키, 체중, 활동량을 입력하면 기초대사량(BMR)과 일일 권장 칼로리(TDEE)를 계산합니다. 체중 감량·유지·증가를 위한 목적별 칼로리도 함께 안내해 식단 계획을 세우는 데 도움이 됩니다.',
    points: [
      'Mifflin-St Jeor 공식으로 정확한 BMR 계산',
      '5단계 활동량 선택으로 TDEE 계산',
      '감량·유지·증가 목적별 권장 칼로리 안내',
    ],
  },
  {
    href: '/hourly',
    title: '시급 계산기',
    summary:
      '시급 계산기는 2026년 최저시급 10,320원을 기준으로 시급에서 일급, 주급, 월급, 연봉을 즉시 계산합니다. 주휴수당 포함 여부를 선택할 수 있으며 최저시급 기준과 비교해 본인의 시급이 적정한지 확인할 수 있습니다.',
    points: [
      '일급·주급·월급·연봉 한 번에 계산',
      '주휴수당 포함 여부 선택 지원',
      '최저시급 기준 비교로 적정 임금 확인',
    ],
  },
  {
    href: '/wolgup-doduk',
    title: '월급 도둑 계산기',
    summary:
      '월급 도둑 계산기는 연봉을 입력하면 국민연금, 건강보험, 장기요양보험, 고용보험, 소득세, 지방소득세 항목별로 얼마나 빠져나가는지 계산합니다. 공제율과 근무연수 누적 손실까지 한눈에 보여줘 내 월급에서 실제로 얼마가 남는지 충격적으로 확인할 수 있습니다.',
    points: [
      '2026년 최신 4대보험 요율 및 소득세 기준 적용',
      '항목별 바 차트로 어디서 가장 많이 빠지는지 시각화',
      '근무연수 기준 누적 손실 금액까지 계산',
    ],
  },
]
...
const faqItems = [
  ...
  },
  {
    ...
    a: '나이 확인은 만나이 계산기, 월급 세후 금액은 급여 계산기, 전세·월세 비교는 전월세 계산기, 알바 임금은 주휴수당·시급 계산기, 저축 계획은 적금 이자 계산기, 대출 상환은 대출 이자 계산기, 체중 관리는 BMI·칼로리 계산기, 중요한 날짜는 디데이 계산기, 퇴사 준비는 퇴직금 계산기를 선택하면 됩니다.',
  },
  {
        ...
        <div className={styles.container}>
          <header className={styles.header}>
            ...
            <p className={styles.desc}>
              만나이, 급여 실수령액, 전월세, 사주, BMI, 디데이, 퇴직금 계산기를 한 곳에서 무료로 사용할 수 있는 생활형 계산기 모음입니다.
