...
export const metadata = {
  title: '계산기 모음 - 만나이, 급여, 전월세, 사주, BMI, 디데이, 퇴직금 계산기',
  description:
    '만나이, 급여 실수령액, 전월세, 사주, BMI, 디데이, 퇴직금 계산기를 한 곳에서 무료로 사용하세요. 2026년 기준 안내와 실용적인 설명을 함께 제공합니다.',
  keywords: ['만나이 계산기', '급여 계산기', '전월세 계산기', '사주 계산기', 'BMI 계산기', '디데이 계산기', '퇴직금 계산기'],
  alternates: { canonical: pageUrl },
  openGraph: {
    title: '계산기 모음',
    description: '만나이·급여·전월세·사주·BMI·디데이·퇴직금 계산기를 무료로 제공합니다.',
    url: pageUrl,
    type: 'website',
    locale: 'ko_KR',
  },
...
const faqItems = [
  ...
  },
  {
    ...
    a: '나이나 법적 기준을 확인하려면 만나이 계산기, 월급 세후 금액을 알고 싶다면 급여 계산기, 전세와 월세 비교가 필요하다면 전월세 계산기, 생년월일 기반 운세 구조가 궁금하다면 사주 계산기, 체중 관리가 필요하다면 BMI 계산기, 중요한 날짜를 챙기려면 디데이 계산기, 퇴사를 앞뒀다면 퇴직금 계산기를 선택하면 됩니다.',
  },
  {
